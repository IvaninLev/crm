...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/lev/projects/crm/public/storage' => 'string',
...
'broadcasting.connections.null.driver','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/lev/projects/crm/public/storage',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','ide-helper.filename','ide-helper.models_filename',
...
'sanctum.csrf-cookie','login','logout','register','password.request','password.email','password.reset','password.update',
'password.confirm','profile','home','users.index',
'users.create','users.show','users.edit','tasks.index','tasks.create',
'tasks.show','tasks.edit','tasks.destroy','storage.local',);
        registerArgumentsSet('views', 
'app','auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset',
'auth.register','auth.verify','emails.welcome','home','home.index',
'layouts.app','layouts.inc.menu','layouts.inc.navigation','pagination::bootstrap-4','pagination::bootstrap-5',
...
'pagination::simple-tailwind','pagination::tailwind','tasks.create','tasks.edit','tasks.inc._form',
'tasks.index','users.create','users.edit','users.inc._form','users.index',
...
'APP_PORT','VITE_PORT','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','FORWARD_DB_PORT','FORWARD_REDIS_PORT',
'FORWARD_MAILPIT_PORT','FORWARD_MAILPIT_DASHBOARD_PORT','PHPMYADMIN_EXT_INT_PORTS','PHPMYADMIN_HOST','SESSION_DRIVER',
'SESSION_LIFETIME','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_FROM_ADDRESS',
'MAIL_FROM_NAME','REDIS_CLIENT','REDIS_HOST','REDIS_PORT',);
